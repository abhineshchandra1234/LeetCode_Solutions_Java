...
/**
 * Intuition
 * we will try to build the string with the given LCP
 * we will ensure all the constraints of LCP are satisfied
 * we will again compute LCP using the obtained word
 * If there are mismatch between and the two LCPs in any cell return ""
 * Approach
 * 
 * Complexity
