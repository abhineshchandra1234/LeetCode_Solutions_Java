 ...
 * Intuition
    ...
    we need to return min days required to make m bouqets using k adjacent bloomed flowers
...
Approach
    ...
    For each day we will check if we can get suitable bouqets using a helper function
    If we get a suitable res, we will try to find more optimized one by trying min days
